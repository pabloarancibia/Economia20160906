...
<title>Configuración de Secretarias</title>
...
<script src="../js/confsec.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR SECRETARIA</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM secretarias ORDER BY sec asc";
            ...
            while($registro2 = mysqli_fetch_array($registro)){
              echo '<tr>
                    ...
                    <td><a href="javascript:editarSec('.$registro2['idsec'].');" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-pencil"></i></a> 
                        <a href="javascript:eliminarSec('.$registro2['idsec'].');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                    </tr>';       
            }
        ?>
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Secretarias</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
   	 <td>Detalle Secretaria:</td>
     <td><input type="text" required="required" name="detsec" id="detsec" maxlength="45" /></td>
     </tr>
     <tr>
     <td colspan="2">
      <div id="mensaje"></div>
