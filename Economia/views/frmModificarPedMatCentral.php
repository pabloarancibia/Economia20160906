...
<form id="form1" name="form1" method="post" action="../Logica/DesplegarPedMatCentral.php" onsubmit="return chkBC(this)">
...
<br>
<div class="row">
<strong><div class="col-md-2" align="right" style="width:20%">SECRETARIA:</div></strong>
<div class="col-md-2">
  <select name="nivel" size=1 style="text-align:center;font-style:bold" required="required">
    <option value='1'>ECONOMIA</option>
    <option value='2'>PLANIFICACION ESTRATEGICA</option>
    <option value='3'>DESARROLLO ECONOMICO</option>
    <option value='4'>AMBIENTE</option>
    <option value='5'>ESPACIO PUBLICO E INFRAESTRUCTURA</option>
    <option value='6'>SECRETARIA GRAL.</option>
    <option value='7'>GOBIERNO</option>
    <option value='8'>CULTURA,TURISMO Y DEPORTE</option>
