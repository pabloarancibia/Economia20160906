...
<html lang="es">
<head>
<title>Seleccion de Secretaria</title>
<meta charset="UTF-8">
...
<form id="form1" name="form1" method="post" action="../Logica/ProcesarPedporSecre.php" onsubmit="return chkBC(this)">
...
<div class="row">
   ...
   <strong>
  <div class="col-md-5" align="left" style="width:20%;">(*)Seleccione Secretaria para realizar el Pedido:</div></strong>
  <div class="col-md-3">
  <select name="secre" size=1 style="text-align:center;font-style:bold" required="required">
    <option value='1'>SEC.ECONOMIA</option>
