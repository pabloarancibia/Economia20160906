    ...
    <div class="registros" id="agrega-registros">
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <th width="50">LOCALIDAD</th>
          <th width="50">PROVINCIA</th> 
          <th width="50">TELEFONO</th>
          <th width="50">F.NAC</th>
          <th width="50">F.ING</th> 
          <th width="50">F.EGR</th>
          <th width="10">SEXO</th>
          <th width="50">E.CIVIL</th> 
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM legajos ORDER BY id asc";
