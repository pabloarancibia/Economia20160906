...
<title>Eliminar Detalle de Pedidos</title>
...
<script src="../js/elideta.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">NUEVO DETALLE DE PEDIDO</button></td>
    <td width="150"><a href="../views/expDetPedMat.php" class="btn btn-danger">EXCEL</a></td>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM detallepedidomateriales ORDER BY idsol asc, idpedido asc;";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Detalle Pedido Excepcional</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>IddetPM: </td>
     <td><input type="text" required="required" name="idd" id="idd" maxlength="11" readonly="readonly" /></td>
     </tr>
     <tr>
     <td>Cantidad:</td>
     <td>
     <input type="text" required="required" name="ct" id="ct" onkeypress="return numeros(event)"/>
     </td>
     </tr>
     <tr>
   	 <td>Importe Detalle:</td>
     <td><input type="text" required="required" name="imp" id="imp" onkeypress="return numeros(event)"/></td>
     </tr>
     <tr>
     <td>Id Rubro:</td>
     <td><input type="text" required="required" name="rub" id="rub" maxlength="45" /></td>
     </tr>
     <tr>
     <td>Id Sub-Rubro:</td>
     <td><input type="text" required="required" name="srub" id="srub" maxlength="45" /></td>
     </tr>
     <tr>
     <td>Detalle Pedido:</td>
     <td><input type="text" required="required" name="detp" id="detp"  /></td>
     </tr>
     <tr>
     <td>Id Pedido:</td>
     <td><input type="text" required="required" name="idped" id="idped" maxlength="45" /></td>
     </tr>
     <tr>
     <td>Id Solicitante:</td>
     <td><input type="text" required="required" name="idsol" id="idsol" maxlength="45" /></td>
     </tr>
     <tr>
     <td colspan="2">
      <div id="mensaje"></div>
