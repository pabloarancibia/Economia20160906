...
<ul><li class="float-left"><a href="#">INSTRUCTIVOS</a>
  <ul class="dropdown-content">
    <li><a href="../images/InstructivoPedidoMateriales.pdf"  target="new">Pedido de Materiales</a></li>
    <li><a href="../images/Rubros_Compras.pdf"  target="new">Rubros Compras</a></li>
   </ul>
  </li></ul>
<?php
   if($level==0||$level==4||$level==5||$level==10||$level==99){?>
<ul>
 <li class="float-left">
   <a href="#">MESA DE ENTRADAS</a>
 <ul class="dropdown-content">
...
<ul>
 ...
 <?php
 if($level==10){?>
	 <li><a href="../views/frmPedporSecre.php">Carga de Pedido de Materiales cualquier Secretaria</a>
  </li>
  <li><a href="../views/frmModificarPedMatCentral.php">Modificar Pedido de Materiales cualquier Secretaria</a>
  </li>

  <?php } 
 
 if($level==1||$level==2||$level==3||$level==5||$level==10||$level==11||$level==99){?>
  ...
  <?php 
   if($level==3||$level==6||$level==10||$level==11||$level==12||$level==99){?>
  <li><a href="../views/frmConGestCom.php">Seguimiento de Pedido de Materiales</a>
  </li>
  <?php }?>
  <?php 
  if($level==5||$level==6||$level==10||$level==11||$level==12||$level==99){?>
  ...
  <li><a href="../views/frmReimpresionPedMat.php">Reimpresion de Pedidos de Materiales</a>
  <?php }?></li> 
  <li><?php 
  if($level==5||$level==6||$level==10||$level==12||$level==99){?>
  <a href="../views/frmR2PedMat.php">Reimpresion de Pedidos de Materiales por Secretaria </a>
  <?php }?></li>
  <li><?php 
  if($level==3||$level==99){?>
  <a href="../views/frmGestionCompras.php">Gestión Compras</a>
  <?php }?></li>
  <?php 
  if($level==99){?>
  <li><a href="../views/frmElimCabecera.php">Configurar Cabecera de Pedido de Materiales</a>
  </li>
  <li><a href="../views/frmElimDetalle.php">Configurar Detalle Pedido de Materiales</a>
  </li>
  <li><a href="../views/frmCabeceraGestion.php">Excepcion Gestion Compra</a>
  </li>
  <?php }?>
  </ul>
 </li>
...
<li class="float-left"><a href="#">HORAS EXTRAS</a>
 <ul class="dropdown-content">
  <?php 
   if($level==4||$level==99){?>
   <li><a href="../views/frmConfigGrupoCobro.php">Configurar Grupos de Cobro</a></li>
   <li><a href="../views/frmConfigCatEmp.php">Configurar Categorias de Empleados</a></li>
   <li><a href="../views/frmConfigMotHas.php">Configurar Motivos de Horas Extras</a></li>
   <li><a href="../views/frmConfigPerHas.php">Configurar Periodos de Horas Extras</a></li>
   <li><a href="../views/frmConfigNovHas.php">Configurar Tipo de Novedades</a></li>

   <li><a href="../views/frmAltaEmpleado.php">Alta de Legajos de Personal</a></li>
   <?php 
   }
  if($level==1||$level==2||$level==3||$level==4||$level==10||$level==99){?>
  <li><a href="../views/frmAltaNovEmpleado.php">Solicitud de Horas Extras</a></li>
  <li><a href="">Modificar Solicitud de HS.EX.</a></li> <?php }?>
  <?php
  if($level!=0){?>
  <li><a href="">Consulta de Estado de Solicitud de HS.EX.</a></li>
  <?php }?>
  <?php 
  if($level==4||$level==6||$level==10||$level==11||$level==12||$level==99){?>
  <li><a href="">Autorización HS.EX.</a></li>
  <?php }?>
<li><?php 
  if($level==1||$level==2||$level==3||$level==4||$level==10||$level==11||$level==99){?>
  <a href="" target="blank" >Listar Ultimo Pedido de Horas Extras Cargado</a></li>
  <li><a href="" target="blank">Reimpresion de Pedidos de Horas Extras</a>
  <?php }?></li> 
  <li><?php 
  if($level==5||$level==6||$level==10||$level==12||$level==99){?>
  <a href="" target="blank">Reimpresion de Pedidos de Horas Extras por Secretaria </a>
  <?php }?></li>
  </ul>
</li>
</ul>
...
<li class="float-left"><?php 
 ...
 <a href="#">AGENDA</a>
 <ul class="dropdown-content">
 <li><a href="../views/frmAtencionPr.php">Atencion de Proveedores</a></li>
 <li><a href="../views/frmListaTurnoPr.php">Listado Diario de Turnos de Atencion</a>
 </li>
 <li><a href="../views/frmConTurnosAT.php">Seguimiento de Proveedores Atendidos</a></li>
 </ul><?php }?>
</li>
</ul>
<ul>
 <li class="float-left"><a href="#">USUARIOS</a>
  ...
  <li><?php 
  if($level==10||$level==99){?>
  <a href="../views/frmAltaUser2.php">Modificación de Permisos de Usuarios del Sistema</a>
  <?php }?>
  </li>
  <li><a href="../views/frmModiCUsuario.php">Cambio de Clave Usuarios del Sistema</a></li>
  <li><?php 
  if($level==99){?>
  <a href="../views/frmBajaUsers.php">Baja de Usuarios del Sistema</a>
  <?php }?>
  </li> </ul>
 </li>
</ul>
<ul>
 <li class="float-left"><?php 
  ...
  <a href="#">REPORTES</a>
  <ul class="dropdown-content">
   <li><a href="../views/frmBDP.php">Datos Proveedores</a><?php }?></li>
   <?php 
...
<ul>
 <li class="float-left"><?php 
  ...
  <ul class="dropdown-content">
   <li><a href="../views/frmConfigSec.php">Configurar Secretarias</a></li>
   <li><a href="../views/frmConfigSSec.php">Configurar Sub-Secretarias</a></li>
   <li><a href="../views/frmConfigDg.php">Configurar Dcciones Grales</a></li>
   <li><a href="../views/frmConfigRubros.php">Configurar Rubros</a></li>
   <li><a href="../views/frmConfigSRubros.php">Configurar Subrubros</a></li>
   <li><a href="../views/frmConfigDemandas.php">Configurar demandas</a></li>
   <li><a href="../views/frmConfigAbogados.php">Configurar abogados</a></li>
   </ul><?php }?>
</li>
</ul>
<ul>
  <li class="float-left"><a href="#">PRESUPUESTO 2017</a>
    <ul class="dropdown-content">
      <li><a href="../images/Ppto2017- Formularios_Instructivos.pdf" target="new">Instructivo de Carga y Presentación</a></li>
      <li><a href="../views/descargarPres2017.php">Descargar Archivos de Trabajo</a></li>
    </ul>
  </li>
</ul>
</div>
