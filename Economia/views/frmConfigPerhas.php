...
<title>Configuración de Periodos de Horas Extras</title>
...
<script src="../js/confperhas.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR PERIODOS DE HORAS EXTRAS</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM periodohoras ORDER BY aniohs desc, meshs desc;";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Periodos de Horas Extras</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>Año Horas (año actual):</td>
     <td>
     <input type="text" required="required" name="aniohs" id="aniohs" maxlength="4" onkeypress="return numeros(event)" />
     </td>
     </tr>
     <tr>
   	 <td>Mes Horas():</td>
     <td><select name="meshs" id="meshs" size=1 style="text-align:center;font-style:bold" required="required">
     ...
     <tr>
     <td>Descripcion Mes Horas(Ej:ENE-16):</td>
     <td>
     <input type="text" name="descriper" id="descriper" maxlength="6" onkeyup="javascript:this.value=this.value.toUpperCase();"  readonly="readonly" />
     </td>
     </tr>
     <tr>
     <td colspan="2">
