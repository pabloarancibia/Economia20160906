...
<title>Configuración de Direcciones Generales</title>
...
<script src="../js/confdg.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR DCCIONES.GRALES.</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM dirgenerales ORDER BY issec asc, dirgral asc";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Dcciones.Grales</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>Id.Dccion.Gral: </td>
     <td><input type="text" required="required" name="iddg" id="iddg" maxlength="11" readonly="readonly" /></td>
     </tr>
     <tr>
     <td>Nro.Dccion Gral:</td>
     <td>
     <input type="text" required="required" name="numdg" id="numdg" maxlength="5" />
     </td>
     </tr>
     <tr>
   	 <td>Detalle Dccion Gral.:</td>
     <td><input type="text" required="required" name="detdg" id="detdg" maxlength="80" /></td>
     </tr>
     <tr>
     <td>Nro.Sub-Secretaria:</td>
     <td>
     <input type="text" required="required" name="numssec" id="numssec" maxlength="5" />
     </td>
     </tr>
     <tr>
     <td colspan="2">
