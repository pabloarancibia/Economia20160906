...
<title>Configuración de Grupos de Cobro</title>
...
<script src="../js/confgpocobro.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR GRUPOS DE COBRO</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM gruposcobros ORDER BY idgrupo asc";
            ...
            while($registro2 = mysqli_fetch_array($registro)){
              echo '<tr>
                    ...
                    <td><a href="javascript:editarGpo('.$registro2['id'].');" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-pencil"></i></a> 
                        <a href="javascript:eliminarGpo('.$registro2['id'].');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                    </tr>';       
            }
        ?>
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Grupos de Cobro</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>Nro.Grupo de Cobro:</td>
     <td>
     <input type="text" required="required" name="idgrupo" id="idgrupo"maxlength="5" />
     </td>
     </tr>
     <tr>
   	 <td>Descripcion Grupo de Cobro:</td>
     <td><input type="text" required="required" name="descrigpo" id="descrigpo" maxlength="100" /></td>
     </tr>
     <tr>
     <td colspan="2">
      <div id="mensaje"></div>
