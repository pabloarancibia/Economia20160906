...
<div class="row">
   <div class="col-md-1"></div>
   <strong>
  <div class="col-md-1" align="left" style="width:10%;">(*)Función:</div></strong>
  <div class="col-md-3">
  <select name="nivel" size=1 style="text-align:center;font-style:bold" required="required">
    <option value='0'>OPERADOR MESA DE ENTRADA</option>
    <option value='1'>OPERADOR PRIVADA</option>
    <option value='2'>OPERADOR PLANIFICACION</option>
    <option value='3'>OPERADOR DESARROLLO</option>
    <option value='4'>OPERADOR AMBIENTE</option>
    <option value='5'>OPERADOR ESP.PUBLICO</option>
    <option value='6'>OPERADOR SECRETARIA GRAL.</option>
    <option value='7'>OPERADOR GOBIERNO</option>
    <option value='8'>OPERADOR CULTURA</option>
    <option value='9'>OPERADOR CONSEJO</option>
	  <option value='10'>USUARIO ECONOMIA</option>
    <option value='11'>SECRETARIO MUNICIPAL</option>
    <option value='12'>DPTO.COMPRAS</option>
    <option value='13'>OPERADOR ECONOMIA</option>
    <option value='14'>USUARIO HORAS EXTRAS</option>
    <option value='15'>USUARIO SUBSECRETARIA</option>
    <option value='16'>SEGUIMIENTO GESTION</option>

    </select>
  </div><div class="col-md-1"></div>
   <strong>
  <div class="col-md-1" align="left" style="width:10%;">(*)Secretaria:</div></strong>
  <div class="col-md-3">
  <select name="secre" size=1 style="text-align:center;font-style:bold" required="required">
    <option value='0'>MESA DE ENTRADA</option>
    <option value='1'>PRIVADA ECONOMIA</option>
    <option value='2'>SEC.PLANIFICACION</option>
    <option value='3'>SEC.DESARROLLO</option>
    <option value='4'>SEC.AMBIENTE</option>
    <option value='5'>SEC.ESP.PUBLICO</option>
    <option value='6'>SEC.GRAL.</option>
    <option value='7'>SEC. GOBIERNO</option>
    <option value='8'>SEC. CULTURA</option>
    <option value='9'>SEC. CONSEJO</option>
    <option value='10'>SEC.ECONOMIA</option>
    <option value='11'>DPTO.COMPRAS</option>
   </select>
  </div></div><br>
  <div class="row"><div class="col-md-1"></div>
  <strong><div class="col-md-1" align="left">(*)CLAVE:</div></strong>
   <div class="col-md-3" align="center" style="width:20%">
