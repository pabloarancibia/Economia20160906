...
$_SESSION["apynom"];$_SESSION["secretaria"];
 if((!empty($_SESSION["razon"]))||(!empty($_SESSION["bddesde"]))
  ||(!empty($_SESSION["bdhasta"]))||(!empty($_SESSION["nroprovd"]))
  ||(!empty($_SESSION["nroprovh"])) 
  ) 
  { unset($_SESSION["razon"]); unset($_SESSION["bddesde"]);
    unset($_SESSION["bdhasta"]);unset($_SESSION["nroprovd"]);
...
<title>Seguimiento de Turnos de Atencion de Proveedores</title>
...
<form  id="form1" name="form1" method="post" action="../Logica/ProcesarConturnosAT.php">
 ...
 <br>
 <div class="row">
  <strong><div class="col-md-3">Por Fecha de Turno de Atencion</div> </strong>
