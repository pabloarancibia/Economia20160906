...
<title>Configuración de Categorias de Empleados</title>
...
<script src="../js/confcatemp.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR CATEGORIAS DE EMPLEADOS</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM categoriaempleados ORDER BY codcat asc";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Categorias de Empleados</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>Codigo Categoria (5 letras):</td>
     <td>
     <input type="text" required="required" name="codcat" id="codcat"maxlength="5" />
     </td>
     </tr>
     <tr>
   	 <td>Descripcion Categoria de Empleado:</td>
     <td><input type="text" required="required" name="descricat" id="descricat" maxlength="60" /></td>
     </tr>
     <tr>
     <td colspan="2">
      <div id="mensaje"></div>
