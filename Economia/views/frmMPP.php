...
<div class="collapse navbar-collapse" id="navbar-1">
 ...
 <li class="dropdown">
   <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">VOLVER A SELECCIONAR CRITERIOS<span class="caret"></span></a>
    ...
    <li><a href="../views/frmMoPrPr.php">Menú</a>
    </li>
   </ul>
 </li>
 </ul>
...
border: 10px solid #ffffff;">
 <section>
  <table border="0" align="center">
   ...
   <td width="150"><a href="../views/explistaMontoProv.php" class="btn btn-primary">EXCEL</a></td>
   <td width="150"><a target="_blank" href="../views/listaMontoProv.php" class="btn btn-danger">PDF</a></td>
