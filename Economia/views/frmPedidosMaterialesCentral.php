...
$usec=$_SESSION["secreped"];
$nropedido=$_SESSION['nropedido'];
$aniopedido= $_SESSION['aniopedido'];
...
<script src="../js/pedmatCentral.js"  type="text/javascript"></script>
<!--[if lt IE 9]>
...
<form  rol="form" id="form1" name="form1" method="post" action="../Logica/agrega_pedidoCabCentral.php">
<!--==============================content================================-->
<div class="row"><strong>
  <div class="col-md-6" align="center">PEDIDO NUMERO: <?php echo $nropedido;  ?></div> <div class="col-md-6" align="center">SECRETARIA:<?php echo $_SESSION["secreped"];?></div></strong>
</div>
...
<div class="row">
<strong><div class="col-md-2" align="left" style="width:20%">CUENTA DESTINO:</div>
<div class="col-md-6">
...
<div class="col-md-3"><strong><h4>TOTAL EN LETRAS:</h4></strong></div>
 <div class="col-md-5"><input name="totalletra" type="text" id="totalletra" style="text-transform:uppercase;color:Black;background-color:WhiteSmoke;border-color:LightSkyBlue;border-width:1px;border-style:Solid;font-family:Verdana;font-size:Small;font-weight:bold;width:80%;" 
 ...
 <div class="modal-dialog">
  ...
  <tr align="center"><td align="center" width="300">Descripción de Bienes/Servicios</td></tr>
   ...
   <tr>
     ...
     <td><input type="text"  name="totalf" id="totalf" required="required" onkeypress="return numeros(event)" />
     </td>
     </tr>
     <tr>
     <td colspan="2">
