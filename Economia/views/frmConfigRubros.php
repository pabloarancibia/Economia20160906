...
<title>Configuración de Rubros</title>
...
<script src="../js/confrub.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR RUBRO</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM rubros ORDER BY rubro asc";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Rubros</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>IdRubro: </td>
     <td><input type="text" required="required" name="idr" id="idr" maxlength="11" readonly="readonly" /></td>
     </tr>
     <tr>
     <td>Nro.Rubro:</td>
     <td>
     <input type="text" required="required" name="numr" id="numr" maxlength="5" />
     </td>
     </tr>
     <tr>
   	 <td>Detalle Rubro:</td>
     <td><input type="text" required="required" name="detr" id="detr" maxlength="100" /></td>
     </tr>
     <tr>
     <td colspan="2">
      <div id="mensaje"></div>
