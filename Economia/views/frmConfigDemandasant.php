...
<title>Configuración de Demandas</title>
...
<script src="../js/confdem.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR demanda</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM acreenciacongestion ORDER BY idcg asc";
            $registro = mysqli_query($conexion,$queryu); 
            while($registro2 = mysqli_fetch_array($registro)){
              echo '<tr>
                    <td>'.$registro2['idcg'].'</td>
                    ...
                    <td><a href="javascript:editarDem('.$registro2['idcg'].');" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-pencil"></i></a> 
                        <a href="javascript:eliminarDem('.$registro2['idcg'].');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                    </tr>';       
            }
        ?>
