...
<title>Configuración de Sub-Secretarias</title>
...
<script src="../js/confssec.js"></script>
<!--[if lt IE 9]>
...
<section>
  <table border="0" align="center">
   <tr>
    <td width="100"><button id="nueva-factura" class="btn btn-primary">AGREGAR SUB-SECRETARIA</button></td>
   </tr>
  </table>
 </section>
        ...
        <table class="table table-striped table-condensed table-hover">
         <tr>
          ...
          <?php
            ...
            $conexion=Conectarse();
            $queryu="SELECT * FROM subsecretarias ORDER BY isec asc, subsec asc";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Configurar Sub-Secretarias</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>IdSub-Secretaria: </td>
     <td><input type="text" required="required" name="idsubsec" id="idsubsec" maxlength="11" readonly="readonly" /></td>
     </tr>
     <tr>
     <td>Nro.Sub-Secretaria:</td>
     <td>
     <input type="text" required="required" name="numsubsec" id="numsubsec" maxlength="5" />
     </td>
     </tr>
     <tr>
   	 <td>Detalle Sub-Secretaria:</td>
     <td><input type="text" required="required" name="detsubsec" id="detsubsec" maxlength="80" /></td>
     </tr>
     <tr>
     <td>Nro.Secretaria:</td>
     <td>
     <input type="text" required="required" name="numsec" id="numsec" maxlength="5" />
     </td>
     </tr>
     <tr>
     <td colspan="2">
