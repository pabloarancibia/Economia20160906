...
<div id="navigation">
 <ul>
  <li class="active float-left"><a class="active" href="/index.php">inicio</a>  
  </li>
 </ul>
  <ul>
 <li class="float-left"><a href="#">Solicitud de Turnos</a>
  <ul class="dropdown-content">
    <li><a href="../views/frmTurnoeco.php">Solicitar Turno de Atencion</a></li>
  </ul>
 </li>
 </ul>
 <ul>
  <li class="float-left"><a href="#">Consulta de Turnos Solicitados</a>
   <ul class="dropdown-content">
    <li><a href="../views/frmVerTurnoeco.php">Consultar Turnos Solicitados</a>
    </li>
   </ul>
  </li>
  </ul>
