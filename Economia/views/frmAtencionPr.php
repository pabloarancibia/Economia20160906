...
<title>Atencion de Proveedores</title>
...
<script src="../js/atenpr.js"></script>
<!--[if lt IE 9]>
...
<table class="table table-striped table-condensed table-hover">
 ...
 $conexion=Conectarse();
 $queryu="SELECT * FROM turnoeco WHERE presenta='' ORDER BY fechaTurno asc, horaTurno asc;";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><b>Atencion a Proveedor</b></h4>
   </div>
   ...
   <div class="modal-body">
    ...
    <input type="text" required="required" readonly="readonly" name="idf" id="idf" readonly="readonly" style="visibility:hidden; height:5px;"/>
     ...
     <tr>
     <td>Rubro: </td>
     <td><input type="text" required="required" name="rubro" id="rubro" maxlength="140" /></td>
     </tr>
     <tr>
     <td>Periodo de Entrega/Prestacion:</td>
     <td>
     <input type="text" required="required" name="peri" id="peri" maxlength="140" />
     </td>
     </tr>
     <tr>
   	 <td>Monto Reclamado $:</td>
     <td><input type="text" required="required" name="montor" id="montor" maxlength="65" onkeypress="return numeros(event);" /></td>
     </tr>
     <tr>
     <td>Ultima Factura Paga: </td>
     <td>
     <input type="text" required="required" name="ufp" id="ufp" maxlength="30" />
     </td></tr>
     <tr>
     <td>Estado:</td>
     <td><input type="text"  required="required" name="estado" id="estado" maxlength="30"/>
     </td>
     </tr>
     <tr>
     <td>Opera Actualmente?: </td>
     <td>
     <input type="text"  required="required" name="opera" id="opera" maxlength="60"/>
     </td>
     </tr>
     <tr>
     <td>Fecha de Respuesta: </td>
     <td>
     <input type="text"  required="required" name="fecha" id="fecha" maxlength="45" />
          </td>
     </tr>
     <tr>
     <td>Observaciones: </td>
     <td>
     <input type="text"  required="required" name="observa" id="observa" maxlength="100" />
     </td>
     </tr>
     <tr>
     <td colspan="2">
